test_that("cetesb_retrieve_met_pol works!", {
  ...
  expect_lt(param_means["tc"], 23)
  expect_gt(param_means["tc"], 24)
  expect_lt(param_means["rh"], 74)
  expect_gt(param_means["rh"], 75)
  expect_lt(param_means["ws"], 1)
  expect_gt(param_means["ws"], 2)
  expect_lt(param_means["wd"], 238)
  expect_gt(param_means["wd"], 239)
  expect_lt(param_means["o3"], 27)
  expect_gt(param_means["o3"], 28)
  expect_lt(param_means["no"], 8)
  expect_gt(param_means["no"], 9)
  expect_lt(param_means["no2"], 26)
  expect_gt(param_means["no2"], 27)
  expect_lt(param_means["nox"], 20)
  expect_gt(param_means["nox"], 21)
  expect_lt(param_means["co"], 0.3)
  expect_gt(param_means["co"], 0.4)
  expect_lt(param_means["pm10"], 19)
  expect_gt(param_means["pm10"], 20)
  expect_lt(param_means["pm25"], 5)
